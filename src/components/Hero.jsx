        ...
        <section id="hero" className="relative h-screen w-full bg-gradient-to-b from-[#001f3f] to-[#003366] overflow-hidden">
            ...
            <div className="relative z-10 container mx-auto px-6 h-full flex flex-col justify-center items-center text-center text-white">
                ...
                <motion.h1
                    ...
                    className="text-4xl sm:text-5xl md:text-7xl font-extrabold mb-6 leading-[1.1] md:leading-tight px-4"
                >
                ...
                >
                    ...
                    <a href="tel:+918870037600" className="flex items-center gap-3 text-blue-100 hover:text-white transition-colors group">
                        <div className="p-2 rounded-full bg-white/10 group-hover:bg-accent transition-colors">
                            <Phone size={20} />
                        </div>
                        <span className="text-xl font-semibold tracking-wide">+91 88700 37600</span>
                    </a>
                </motion.div>
