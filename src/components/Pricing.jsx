...
const Pricing = () => {
  const classicServices = [
    { name: "Express Doorstep Wash", desc: "Single Visit", mrp: "1,200", offer: "1,100", save: "100" },
    { name: "Interior Deep Cleaning", desc: "Single Visit", mrp: "2,750", offer: "2,500", save: "250" },
    { name: "Exterior Rubbing & Waxing", desc: "Single Visit", mrp: "3,250", offer: "2,900", save: "350" },
    { name: "Complete Car Spa", desc: "Interior + Exterior", mrp: "6,000", offer: "4,900", save: "1,100" }
  ];

  const eliteServices = [
    { name: "Express Doorstep Wash", desc: "Single Visit", mrp: "1,400", offer: "1,300", save: "100" },
    { name: "Interior Deep Cleaning", desc: "Single Visit", mrp: "3,500", offer: "2,900", save: "600" },
    { name: "Exterior Rubbing & Waxing", desc: "Single Visit", mrp: "4,000", offer: "3,500", save: "500" },
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-10">
          ...
          <div className="inline-block bg-[#f6f8ec] text-[#4a5320] px-6 py-2 rounded-md font-medium text-sm border border-[#e8ead4]">
            Free Bike Wash Worth ₹599 Complimentary With Express+ Services
          </div>
        </div>
